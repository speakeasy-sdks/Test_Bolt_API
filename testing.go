...
// CreateShipmentTracking - Simulate a shipment tracking update
...
func (s *testing) CreateShipmentTracking(ctx context.Context, request shared.ShipmentTrackingUpdate, security operations.TestingShipmentTrackingCreateSecurity) (*operations.TestingShipmentTrackingCreateResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
