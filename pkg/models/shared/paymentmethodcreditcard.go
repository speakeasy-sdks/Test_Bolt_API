...
type PaymentMethodCreditCard struct {
	...
	BillingAddressInput AddressReference `json:"billing_address_input"`
...
func (o *PaymentMethodCreditCard) GetBillingAddressInputExplicit() *AddressReferenceExplicit {
	return o.GetBillingAddressInput().AddressReferenceExplicit
}

func (o *PaymentMethodCreditCard) GetBillingAddressInputID() *AddressReferenceID {
	return o.GetBillingAddressInput().AddressReferenceID
}
...
func (o *PaymentMethodCreditCardInput) GetBillingAddressInput() AddressReference {
	if o == nil {
		return AddressReference{}
	}
	return o.BillingAddressInput
...
func (o *PaymentMethodCreditCardInput) GetBillingAddressInputExplicit() *AddressReferenceExplicitInput {
	return o.GetBillingAddressInput().AddressReferenceExplicitInput
}

func (o *PaymentMethodCreditCardInput) GetBillingAddressInputID() *AddressReferenceID {
	return o.GetBillingAddressInput().AddressReferenceID
}
