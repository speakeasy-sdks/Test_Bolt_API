...
const (
	SchemasTagExplicit SchemasTag = "explicit"
)
...
func (o *SchemasInput) GetDotTag() SchemasTag {
	if o == nil {
		return SchemasTag("")
	}
	return o.DotTag
...
// SchemasAddressReferenceIDTag - The type of address reference
type SchemasAddressReferenceIDTag string

const (
	SchemasAddressReferenceIDTagID SchemasAddressReferenceIDTag = "id"
)

func (e SchemasAddressReferenceIDTag) ToPointer() *SchemasAddressReferenceIDTag {
	return &e
}

func (e *SchemasAddressReferenceIDTag) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "id":
		*e = SchemasAddressReferenceIDTag(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SchemasAddressReferenceIDTag: %v", v)
	}
}

type Schemas struct {
	// The type of address reference
	DotTag SchemasAddressReferenceIDTag `json:".tag"`
	// The address's ID
	ID string `json:"id"`
}

func (o *Schemas) GetDotTag() SchemasAddressReferenceIDTag {
	if o == nil {
		return SchemasAddressReferenceIDTag("")
	}
	return o.DotTag
}
